<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Phone Number -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="name" value="{{ __('Phone Number (WhatsApp)') }}" />
            <x-jet-input id="name" type="text" class="mt-1 block w-full" wire:model.defer="state.phone" autocomplete="phone" />
            <x-jet-input-error for="name" class="mt-2" />
        </div>
